...
browse open https://example.com   # (no :9222 clone exists — prefer ~/tools/fcdp/fcdp)
# --cdp requires a debug-port Chrome; none runs here. Use ~/tools/fcdp/fcdp instead.
```
