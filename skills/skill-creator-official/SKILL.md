...
- When the skill being created/edited takes an outward action or asserts real-world facts, REQUIRE it to include a Ground-truth gate section pointing to `~/.claude/skills/shared/ground-truth-standard.md`.
